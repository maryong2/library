...
<body>
				...
				<div class="row g-4">
					<div class="col-sm-12 col-xl-12">
						<div class="bg-light rounded d-md-flex align-items-center p-4">
							<video id="video" style="width: 100%; height: 60%; border: 1px solid gray"></video>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row g-4">
					<div class="col-sm-12 col-xl-12">
						...
						<form action="stock-count">
							<input type="submit" id="stock-select" class="btn btn-primary m-2 w-100" value="현황보기" style="margin: 0 !important;" />
						</form>
						<br>
						<button id="switchButton" class="btn btn-primary m-2 w-100" style="margin: 0 !important;">화면전환</button>
					</div>
	...
	let switching = document.getElementById("switchButton");
	let gotolist = document.getElementById("to-list");
	let i = 0;
	let lastResult = "";
